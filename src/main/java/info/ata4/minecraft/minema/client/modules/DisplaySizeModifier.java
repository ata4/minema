...
public class DisplaySizeModifier extends ACaptureModule {
	...
	public void resize(final int width, final int height) {
		try {
			final Method resize = ReflectionHelper.findMethod(Minecraft.class, MC, PrivateMethods.MINECRAFT_RESIZE,
	...
	public void setFramebufferTextureSize(final int width, final int height) {
		try {
			...
			ReflectionHelper.setPrivateValue(Framebuffer.class, fb, width,
					PrivateFields.FRAMEBUFFER_FRAMEBUFFERTEXTUREWIDTH);
			ReflectionHelper.setPrivateValue(Framebuffer.class, fb, height,
					PrivateFields.FRAMEBUFFER_FRAMEBUFFERTEXTUREHEIGHT);
		} catch (final Exception ex) {
